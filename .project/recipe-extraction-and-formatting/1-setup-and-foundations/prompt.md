...
3. PRD.md: Focus on Feature 2.1: Recipe Extraction and Formatting. Note that RAG functionality is explicitly out of scope for this initial implementation.
4. ARCHITECTURE.md: Understand the Next.js full-stack approach, the Prisma/PostgreSQL stack, and the Custom MAS (Multi-Agent System) supervisor pattern.
5. recipe-extraction-and-formatting/global-plan.md: The high-level plan for this feature.
6. recipe-extraction-and-formatting/1-setup-and-foundations/plan-details.md: This is the source of truth for your current task.
7. Your Task: Implement Phase 0
   ...
   Deliverables:
8. Initialize the Next.js 16 project in the workspace root.
9. Install required dependencies: prisma, @prisma/client, and an LLM client library (e.g., openai).
10. Execute npx prisma init.
11. Configure .env with the PostgreSQL connection string.
12. Define the initial Prisma Schema in schema.prisma. You must implement the Recipe, Ingredient, and InstructionStep models exactly as outlined in plan-details.md, including their fields and relations.
13. Generate the Prisma Client: npx prisma generate.
14. Run the initial database migration: npx prisma migrate dev --name init_recipe_schema.
